...
export const heroServices = [
  {
    title: "Web Apps",
    text: "React frontends with Tailwind v4, built for speed and sanity.",
  },
  {
    title: "Sites that sell",
    text: "Clean UX, clear copy, measurable outcomes.",
  },
  {
    title: "Automation",
    text: "From ops scripts to APIs that keep your team in flow.",
  },
];
